...
ALTER TABLE "Opakovane_odchyty"
    ADD CONSTRAINT fk_opa_odch FOREIGN KEY (id_odch) REFERENCES "Odchyty" (id_odch),
    ADD CONSTRAINT fk_opa_zam FOREIGN KEY (id_zam) REFERENCES "Zamestnanci" (id_zam);
